 ...
 public function index(): void
    {
        ...
        if ((!empty($this->dataForm['SendSearchSla']))) {
            ...
            $listTicketSla->listSearchSla($this->dataForm['search_ticket'], $this->dataForm['search_empresa'], $this->dataForm['search_suporte'], $this->dataForm['search_tipo'], $this->dataForm['search_date_start'], $this->dataForm['search_date_end'], $this->dataForm['search_status_anterior'], $this->dataForm['search_status']);
