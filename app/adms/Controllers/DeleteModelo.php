...
class DeleteModelo
{
    ...
    public function index(int|string|null $id = null): void
    {
        ...
        if (!empty($id)) {
            $this->id = (int) $id;
            $deleteMpdelo = new \App\adms\Models\AdmsDeleteModelo();
            $deleteMpdelo->deleteModelo($this->id);            
        } else {
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Necessário selecionar uma Modelo!</p>";
        }
