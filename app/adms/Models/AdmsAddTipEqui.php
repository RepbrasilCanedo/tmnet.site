...
class AdmsAddTipEqui
{
    ...
    private function add(): void
    {
        ...
        $createSit->exeCreate("adms_type_equip", $this->data);

        if ($createSit->getResult()) {
            $_SESSION['msg'] = "<p class='alert-success'>Tipo de equipamento cadastrado com sucesso!</p>";
            $this->result = true;
        } else {
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Tipo de equipamento não cadastrado com sucesso!</p>";
            $this->result = false;
        }
    }
