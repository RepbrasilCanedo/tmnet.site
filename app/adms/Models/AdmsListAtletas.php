...
class AdmsListAtletas
{
    ...
    public function listAtletas(): void
    {
        ...
        // Buscamos os atletas ordenando pela maior pontuação (Ranking)
        $listAtletas->fullRead("SELECT usr.id, usr.empresa_id, emp.razao_social AS razao_social, emp.nome_fantasia AS nome_fantasia, usr.name, usr.apelido, usr.estilo_jogo, usr.mao_dominante, usr.pontuacao_ranking, usr.adms_access_level_id, usr.adms_sits_user_id   
