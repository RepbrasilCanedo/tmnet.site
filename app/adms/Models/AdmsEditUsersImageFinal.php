...
class AdmsEditUsersImageFinal
{
     ...
     * @return boolean
     */
    public function viewUserClieFin(int $id): bool
    {
        $this->id = $id;
    ...
    public function update(array $data = null): void
    {
        ...
        $this->dataImagem = $this->data['new_image_clie_fin'];
        unset($this->data['new_image_clie_fin']);
    ...
    private function valInput(): void
    {
        ...
        if (($this->viewUserClieFin($this->data['id'])) and ($valExtImg->getResult())) {
            $this->upload();
        } else {
            $this->result = false;
        }
    ...
    private function upload(): void
    {
        ...
        $this->directory = "app/adms/assets/image/usersfinal/" . $this->data['id'] . "/";
    ...
    private function edit(): void
    {
        ...
        if ($upUser->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Usuário final não editado com sucesso!</p>";
            $this->result = false;
        }
    }
    ...
    private function deleteImage(): void
    {
        if (((!empty($this->resultBd[0]['image'])) or ($this->resultBd[0]['image'] != null)) and ($this->resultBd[0]['image'] != $this->nameImg)) {
            $this->delImg = "app/adms/assets/image/usersfinal/" . $this->data['id'] . "/" . $this->resultBd[0]['image'];
            if (file_exists($this->delImg)) {
                unlink($this->delImg);
            }
        }

        $_SESSION['msg'] = "<p class='alert-success'>Imagem do usuario final editada com sucesso!</p>";
        $this->result = true;
    }
}
