...
/**
 * Visualizar setores da empresa no banco de dados
 *
...
class AdmsViewSetor
{
    ...
    public function viewSetor(int $id): void
    {
        ...
        $viewSetor->fullRead("SELECT id, name, created, modified FROM adms_setor  WHERE id=:id LIMIT :limit", "id={$this->id}&limit=1");
