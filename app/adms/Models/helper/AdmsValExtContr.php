...
class AdmsValExtContr
{
     ...
     * @return void
     */
    public function validateExtContr(string $mimeType): void
    {
        ...
        switch ($this->mimeType) {
            case 'contratos/pdf':
                ...
                break;
            default:
                $_SESSION['msg'] = "<p class='alert-danger'>Erro: Necessário selecionar um arquivo em PDF!</p>";
                $this->result = false;
        }
    }
}
