...
<style>
    ...
    /* Células da Tabela */
    .list-table tbody td {
        padding: 14px 15px; /* Aumenta o respiro (espaçamento) entre os textos */
        border-bottom: 1px solid #eef2fa; /* Linha de separação sutil */
        color: #444;
        font-size: 14px;
        vertical-align: middle;
    }

    /* O SEGREDO: Efeito Zebra (Linhas Alternadas) */
    .list-table tbody tr:nth-child(even) {
        background-color: #f8f9fa; /* Cinza muito clarinho para as linhas pares */
    }
    .list-table tbody tr:nth-child(odd) {
        background-color: #ffffff; /* Branco para as linhas ímpares */
    }

    /* Efeito Hover (Destaca a linha ao passar o rato) */
    .list-table tbody tr:hover {
        background-color: #e2e8f0; /* Um tom ligeiramente mais escuro */
